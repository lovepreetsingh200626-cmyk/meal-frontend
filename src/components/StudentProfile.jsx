...
export default function StudentProfile({ user, onUpdateSuccess, onBack }) {
  ...
  // Pre-fill form with existing user data including complete academic, parental & domicile details
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-10 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm mt-1.5">View your details or update personal information. Academic updates are restricted to administration.</p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 text-blue-900 px-4 py-3 rounded-2xl text-xs mb-6 flex items-center gap-3">
            ...
            <span>Academic records, faculty, parental names, IDs, and category profiles are locked under student access. Updates to these fields are handled exclusively by the Committee Administrator.</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 opacity-75">
                ...
                <div className="flex items-center gap-2 text-slate-700 font-semibold text-sm">
                  <ShieldCheck className="w-4 h-4 text-blue-600" /> {user.rollNo}
                </div>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 opacity-75">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">Hostel (Locked)</label>
                <div className="flex items-center gap-2 text-slate-700 font-semibold text-sm">
                  <Building className="w-4 h-4 text-blue-600" /> {user.hostelNo}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 bg-slate-50/70 border border-slate-200/80 rounded-2xl p-5">
              <h3 className="text-xs font-black text-slate-500 uppercase tracking-wider mb-2">University / Parental Records (Managed by Admin)</h3>
              ...
              <div>
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">University / College</label>
                <div className="relative mt-1">
              ...
              <div>
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Department / Course Branch</label>
                <div className="relative mt-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className="w-full mt-1 bg-slate-100 border border-slate-200 rounded-xl py-2.5 px-3.5 text-sm text-slate-600 cursor-not-allowed font-medium uppercase"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1 group">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl py-3 pl-11 pr-4 text-slate-900 text-sm focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 focus:bg-white transition font-medium"
                      onChange={e => {
